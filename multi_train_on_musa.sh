...
torchrun --nproc_per_node=${GPU_NUM} \
    run.py /home/dist/datasets/RetailRocket/retailrocket_processed_view_train_full.tsv \
    -t /home/dist/datasets/RetailRocket/retailrocket_processed_view_test.tsv \
    -m 1 5 10 20 \
